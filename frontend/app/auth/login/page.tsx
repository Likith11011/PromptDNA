...
export default function LoginPage() {
  ...
  async function handleSubmit() {
    ...
    try {
      ...
      if (e?.response?.status === 401) {
        ...
        message = "Invalid request format. Please verify your email and password."
  ...
  return (
    <div className="min-h-screen bg-[#07090e] text-slate-100 flex items-center justify-center px-4 py-12 relative overflow-hidden bg-cyber-grid">
      ...
      <div className="absolute top-1/3 left-1/2 -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-indigo-600/15 rounded-full blur-[120px] pointer-events-none" />
      ...
      <div className="w-full max-w-md relative z-10 space-y-6">
        ...
        <div className="text-center space-y-2">
          ...
          <p className="text-slate-400 text-xs">
            Access your AI prompt diagnostic studio and personal behavioral DNA profile.
          </p>
        </div>
